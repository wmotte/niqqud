...
# read hebrew
#infile <- 'mixed.txt'
#outfile <- 'hebrew_with_niqqud.txt'
infile <- args[ 1 ]
outfile <- args[ 2 ]
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB31" ), stringi::stri_unescape_unicode( "\\u05D1" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB4A" ), stringi::stri_unescape_unicode( "\\u05EA" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB39" ), stringi::stri_unescape_unicode( "\\u05D9" ) )

# YOD 2
#Char: 'יִ' u: 64285 [0xFB1D] b: 239,172,157 [0xEF,0xAC,0x9D] n: HEBREW LETTER YOD WITH HIRIQ [Alphabetic Presentation Forms]
#Char: 'י' u: 1497 [0x05D9] b: 215,153 [0xD7,0x99] n: HEBREW LETTER YOD [Hebrew]
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB1D" ), stringi::stri_unescape_unicode( "\\u05D9" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB3C" ), stringi::stri_unescape_unicode( "\\u05DC" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB44" ), stringi::stri_unescape_unicode( "\\u05E4" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB3E" ), stringi::stri_unescape_unicode( "\\u05DE" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB35" ), stringi::stri_unescape_unicode( "\\u05D5" ) )

# VAV 2
#Char: 'וֹ' u: 64331 [0xFB4B] b: 239,173,139 [0xEF,0xAD,0x8B] n: HEBREW LETTER VAV WITH HOLAM [Alphabetic Presentation Forms]
#Char: 'ו' u: 1493 [0x05D5] b: 215,149 [0xD7,0x95] n: HEBREW LETTER VAV [Hebrew]
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB4B" ), stringi::stri_unescape_unicode( "\\u05D5" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB3B" ), stringi::stri_unescape_unicode( "\\u05DB" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB40" ), stringi::stri_unescape_unicode( "\\u05E0" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB32" ), stringi::stri_unescape_unicode( "\\u05D2" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB33" ), stringi::stri_unescape_unicode( "\\u05D3" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB2C" ), stringi::stri_unescape_unicode( "\\u05E9" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB41" ), stringi::stri_unescape_unicode( "\\u05E1" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB46" ), stringi::stri_unescape_unicode( "\\u05E6" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB36" ), stringi::stri_unescape_unicode( "\\u05D6" ) )
...
#df <- stringi::stri_replace_all( df$vars, fixed = stringi::stri_unescape_unicode( "\\uFB47" ), stringi::stri_unescape_unicode( "\\u05E7" ) )
